...
public class HashMap<K, V> implements Iterable<HashMap.Entity> {
    ...
    class HashMapIterator implements Iterator<HashMap.Entity> {
        ...
        public boolean hasNext() {
            while (index < hashmap.buckets.length && hashmap.buckets[index] == null) {
                index++;
            }
            return index < hashmap.buckets.length;
        }
        ...
        public Entity next() {
            ...
            if (index < hashmap.buckets.length) {
                Node node = hashmap.buckets[index].head;
                hashmap.buckets[index].head = node.next;
                index++;
                return node.value;
            } else {
